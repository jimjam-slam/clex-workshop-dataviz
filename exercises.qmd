...
ggsave(here("test.png"), my_plot, bg = "white")
```
...
You can also change the font and make the text bigger with a theme function!
...
### Changing individual pieces of text (that aren't linked to your data)
...
> The `rel()` function lets you grow or shrink text, instead of using a fixed size.
> 
...
(Remember, you'll need to save this plot using `ggsave` to see the fonts!)
...
- We could add a couple of fixed labels to the corners of the panels
